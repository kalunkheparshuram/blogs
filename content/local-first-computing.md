...
- A local note-taking and documentation platform
- A personal photo management system
...
## Building with AI
Modern AI coding assistants have lowered the barrier to entry for many technical projects.
Even if you are not an experienced software developer, tools such as Claude Code, ChatGPT, and other assistants can help generate boilerplate code, explain unfamiliar concepts, and accelerate experimentation.
That does *not* replace understanding the fundamentals.
The responsibility remains with the builder to review generated code, understand its behavior, test it thoroughly, and secure the resulting system.
AI is a powerful assistant—but not a substitute for engineering judgment.
